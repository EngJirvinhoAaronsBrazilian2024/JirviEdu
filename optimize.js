...
function optimizeFile(filePath) {
  ...
  // Remove setInterval polling from student components and rely only on mutationEmitter (or increase it heavily)
  // 3000ms is too aggressive. We'll remove setInterval completely since mutationEmitter handles local, and they can refresh for remote, OR we set it to 60000.
  content = content.replace(
