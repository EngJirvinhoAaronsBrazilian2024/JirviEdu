      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <div className="bg-[var(--bg-card)] p-5 rounded-2xl border border-[var(--border-subtle)] shadow-sm flex items-center gap-4 relative overflow-hidden group hover:shadow-md transition-all">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-2xl font-bold text-[var(--text-main)] mt-0.5">{initialEnrolled.size}</span>
          </div>
        </div>

        <div className="bg-[var(--bg-card)] p-5 rounded-2xl border border-[var(--border-subtle)] shadow-sm flex items-center gap-4 relative overflow-hidden group hover:shadow-md transition-all">
          <div className="p-3 rounded-xl shrink-0 bg-slate-50 text-slate-600 dark:bg-slate-500/10 dark:text-slate-400">
            <CheckCircle className="w-6 h-6" strokeWidth={2} />
          </div>
          <div className="flex flex-col">
            <p className="text-xs font-semibold text-muted uppercase tracking-wider">Selected Modules</p>
            <span className="text-2xl font-bold text-[var(--text-main)] mt-0.5">{selectedModuleIds.size}</span>
          </div>
        </div>
        ...
        <div className="bg-[var(--bg-card)] p-5 rounded-2xl border border-[var(--border-subtle)] shadow-sm flex items-center gap-4 relative overflow-hidden group hover:shadow-md transition-all">
          ...
          <div className="flex flex-col">
            <p className="text-xs font-semibold text-muted uppercase tracking-wider">Total Available</p>
