              ...
              <tbody className="divide-y divide-neutral-700">
                {materials.map(mat => (
                  <tr key={mat.id}>
                    ...
                    <td className="px-6 py-4 text-sm text-blue-400 hover:text-blue-300"><a href={mat.fileUrl} target="_blank" rel="noreferrer">Download / View</a></td>
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <button onClick={() => handleDelete(mat.id)} className="text-red-400 hover:text-red-300"><Trash2 className="w-5 h-5"/></button>
                    </td>
                  </tr>
                ))}
