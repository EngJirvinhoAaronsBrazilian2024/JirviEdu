      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="premium-card p-6 md:p-8 lg:col-span-2">
          ...
          <div className="flex flex-col flex-1">
            <p className="text-[10px] sm:text-xs font-semibold text-muted uppercase tracking-wide leading-tight">Students</p>
            <span className="text-xl sm:text-2xl font-bold text-[var(--text-main)] mt-0.5">{stats.students}</span>
          </div>
        </div>
          ...
          <div className="flex flex-col flex-1">
            <p className="text-[10px] sm:text-xs font-semibold text-muted uppercase tracking-wide leading-tight">Modules</p>
          ...
          <div className="flex flex-col flex-1">
            <p className="text-[10px] sm:text-xs font-semibold text-muted uppercase tracking-wide leading-tight">Assignments</p>
          ...
          <div className="flex flex-col flex-1">
            <p className="text-[10px] sm:text-xs font-semibold text-muted uppercase tracking-wide leading-tight">Lectures</p>
            <span className="text-xl sm:text-2xl font-bold text-[var(--text-main)] mt-0.5">{stats.lectures}</span>
          </div>
        </div>
          </div>
        </div>
