  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto">
      <div className="sm:flex sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-white">Modules Management</h1>
      ...
      <div className="bg-neutral-800 p-6 rounded-xl border border-neutral-700 shadow-sm">
        <h2 className="text-lg font-medium text-white mb-4">Add New Module</h2>
        <form onSubmit={handleAdd} className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <button type="submit" className="md:col-span-3 flex justify-center items-center px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 text-sm font-medium">
      ...
      <div className="bg-neutral-800 rounded-xl border border-neutral-700 shadow-sm overflow-hidden overflow-x-auto">
        <table className="min-w-full divide-y divide-neutral-200">
          ...
          <tbody className="divide-y divide-neutral-200">
            {modules.map(mod => (
              <tr key={mod.id}>
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-white">{mod.code}</td>
